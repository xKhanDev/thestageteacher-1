...
export const tools = [
  ...
  // Classroom Management 
  {
    ...
    fields: [
      ...
      { name: "frequency", labelKey: "fields.frequency.label", type: "select", optionsKey: "fieldOptions.frequencies" },
      { name: "environmentContext", labelKey: "fields.environmentContext.label", type: "text", placeholderKey: "fields.environmentContext.placeholder" }
    ]
  },
  {
    id: 20,

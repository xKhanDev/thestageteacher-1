...
const CaseStudies = () => {
  ...
  return (
    <div className={`min-h-screen bg-gradient-to-br from-blue-50 via-indigo-50 to-purple-50 transition-all duration-1000 ${isVisible ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-10'}`}>
      {/* Header */}
      <header className="bg-white/90 backdrop-blur-sm border-b border-blue-100 shadow-lg sticky top-0 z-50">
        ...
        <div className="max-w-7xl mx-auto text-center">
          <div className="mb-8">
            ...
            <p className="text-xl text-gray-600 max-w-3xl mx-auto">
              Discover how schools worldwide are transforming education with Ecerta's innovative solutions.
            </p>
          </div>
        </div>
      </section>
        ...
        <div className="max-w-7xl mx-auto">
          <div className="grid grid-cols-1 lg:grid-cols-1 gap-12">
            {caseStudies.map((study, index) => (
              <Card key={index} className="group hover:shadow-2xl transition-all duration-500 border-0 bg-gradient-to-br from-white to-gray-50 overflow-hidden animate-fade-in" style={{ animationDelay: `${index * 0.2}s` }}>
                <div className="flex flex-col lg:flex-row">
                  ...
                  <div className="lg:w-2/3 p-8">
                    ...
                    <p className="text-lg text-blue-600 font-semibold mb-4">{study.school}</p>

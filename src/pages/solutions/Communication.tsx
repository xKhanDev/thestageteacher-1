...
>>>>>>> a83eb990b2c666f2511a6b09cca6bbf45f81cdf6
        ...
        <div className="bg-[#2901b3] rounded-2xl p-8 mb-16">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8 text-center">
            <div>
              <Megaphone className="h-12 w-12 text-white mx-auto mb-4" />
              <h3 className="text-xl font-semibold mb-2 text-white">Instant</h3>
              <p className="text-gray-200">Mass Communication</p>
            </div>
            <div>
              <Bell className="h-12 w-12 text-white mx-auto mb-4" />
              <h3 className="text-xl font-semibold mb-2 text-white">Smart</h3>
              <p className="text-gray-200">Automated Alerts</p>
            </div>
            <div>
              ...
              <p className="text-gray-200">Multi-Language Support</p>
            </div>
          </div>
        </div>

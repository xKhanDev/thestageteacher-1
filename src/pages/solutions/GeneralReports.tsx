        ...
        <div className="bg-[#2901b3] rounded-2xl p-8 mb-16">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8 text-center">
            <div>
              ...
              <p className="text-gray-200">Live Data Updates</p>
            </div>
            <div>
              ...
              <p className="text-gray-200">Predictive Analytics</p>
            </div>
            <div>
              <FileSpreadsheet className="h-12 w-12 text-white mx-auto mb-4" />
              <h3 className="text-xl font-semibold mb-2 text-white">Custom</h3>
              <p className="text-gray-200">Tailored Reports</p>
            </div>
          </div>
        </div>

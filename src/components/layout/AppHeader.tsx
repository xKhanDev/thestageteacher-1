        ...
        <div className="flex items-center justify-between h-16">
          <div className="flex items-center space-x-3">
            ...
            <div>
              ...
              <p className="text-xs text-gray-700 font-medium">{t('easyteach.header.aiTeachingAssistant')}</p>
            </div>
          </div>
          ...
          <div className="flex items-center space-x-4">
            <div className="flex items-center space-x-2 bg-gradient-to-r from-blue-50 to-indigo-50 px-3 py-2 rounded-full border-2 border-blue-200">
              ...
              <span className="text-xs font-semibold text-blue-800">{t('easyteach.header.saveHours', { hours: '10' })}</span>
            ...
            <div className="flex items-center space-x-2">
              ...
              >
                ...
                <span className="max-w-20 truncate">{teacherProfile?.name || user?.user_metadata?.name || user?.email || t('easyteach.header.profile')}</span>
              </Button>
              <Button
                variant="outline"
                size="sm"
